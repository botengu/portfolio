---
layout: post
title:  Morphing of Parametrized Surfaces  
...
<div class="w3-row ">
    <h1 style="text-align:center">Morphing of Parametrized Surfaces</h1>
    <p class = "justify">
    ...
    <div class="w3-main w3-center" >
        <img src="/portfolio/assets/img/BezierSurfac.gif" width="70%" height="70%">
