...
---
  ...
  <div class="w3-row ">
      <h1 style="text-align:center">Visualizing the evolution of exchange rate </h1>
        ...
        <br>
        <p class = "justify">
        We can make a graph by plotting the exchange rate between two currencies (say the US dollar (USD) and the Japanese Yen (JPY) ) between the 3rd of July and today (which happens to be the 3rd of August 2022). The idea is that we can use this time interval to predict how the trend will keep on going and buy the bet on the right exchange rate.
        </p>
        <div class="w3-main w3-center" >
